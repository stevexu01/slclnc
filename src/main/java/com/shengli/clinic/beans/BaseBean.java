...
public class BaseBean {
	 ...
	 protected static final String CREATE_SUCCESSFULLY = "createSuccessfully";
	 protected static final String UPDATE_SUCCESSFULLY = "updateSuccessfully";
	 ...
	 protected void setWarnMessage(String summary) {
		 FacesContext context = FacesContext.getCurrentInstance(); 
		 context.addMessage(null, new FacesMessage(FacesMessage.SEVERITY_WARN, summary, null));
	 }
	 ...
	 protected static String getMessageFromResource(String bundleName,
